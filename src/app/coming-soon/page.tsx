...
const introSection = {
  ...
  description:
    "We are currently working on getting this service online, meanwhile please contact us directly to start your claim",
} as const;
      ...
      lines: [
        {
          ...
          parts: [
            {
              type: "text" as const,
              value: "Write to us at the following e-mail address",
            },
          ],
        },
        {
...
export default function ComingSoonPage() {
  return (
    <main className="flex flex-1 flex-col bg-white">
      ...
      <InfoCardsSection
        heading={contactMethodsCards.heading}
        cards={contactMethodsCards.cards}
      />
    </main>
  );
}
