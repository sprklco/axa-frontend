    ...
    packages: [
        {
            ...
            features: {
                geographic: "MENA, France",
                inHospital: "",
                financialLimit: "Unlimited",
                otherLimit: "720 days per lifetime",
                ageLimit: "From 0 to 65 (can be extended to 75)",
                excess: "-",
                network: "Full",
                ...
                continuity: "Yes (previous 1 year continuous policy)",
        ...
        },
        {
            ...
            features: {
                ...
                ageLimit: "From 0 to 65 (can be extended to 75)",
                excess: "-",
                network: "Full Network for the following diseases:\n1- Open Heart Surgeries\n2- Major Brain Surgeries\n3- Major Burns (3rd degree and above)\n4- Cancer\n5- One ER case not related\n\nLimited (Excluding CMC, KMC, SGO, and Rizk/Saint-John) for other cases",
                gr: "Granted from Day 0 with immediate Effective Date,\nin addition to 180 Days Observation Period to take the appropriate Underwriting decision (Exclusions/Limitations)",
                continuity: "Yes (previous 1 year continuous policy)",
                internationalAssistance: "",
                financialLimitOutside: "-",
                accessWorldwide: "On Reimbursement basis only up to Lebanese tariffs",
